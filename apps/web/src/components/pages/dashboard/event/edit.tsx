    ...
    <div className="flex flex-1">
      <form onSubmit={handleSubmit(onSubmit)} className="flex w-full flex-col justify-start gap-4">
        ...
        <div className="grid w-full grid-cols-2 gap-4">
          ...
          <DatePicker
            label="Start date"
            defaultValue={parseDate(initialData.start_date)}
          ...
          <DatePicker
            label="End date"
            defaultValue={parseDate(initialData.end_date)}
            onChange={(e: DateValue) => {
              if (e) {
          ...
          <DatePicker
            ...
            defaultValue={parseDate(initialData.registration_opens_date)}
            onChange={(e: DateValue) => {
              if (e) {
          ...
          <DatePicker
            ...
            defaultValue={parseDate(initialData.registration_ends_date)}
            onChange={(e: DateValue) => {
              if (e) {
