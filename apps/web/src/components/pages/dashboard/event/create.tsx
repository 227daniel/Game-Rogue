              ...
              <div className="mb-8 grid w-full grid-cols-2 gap-4">
                <div className="w-full">
                  <div className="grid w-full items-center gap-1.5">
                    ...
                    <CustomInputDatePicker onSelect={(value) => setValue('start_date', value)} />
                  </div>
                </div>
                <div className="w-full">
                  <div className="grid w-full items-center gap-1.5">
                    ...
                    <CustomInputDatePicker onSelect={(value) => setValue('end_date', value)} />
                  </div>
                </div>
              </div>
              <div className="mb-8 grid w-full grid-cols-2 gap-4">
              ...
              <div className="mb-8 grid w-full grid-cols-2 gap-4">
                ...
                <div className="w-full">
                  <div className="grid w-full items-center gap-1.5">
                    <h6 className="text-[1.25rem] text-white">
                      Entry Fee
                      <span className="ml-1 cursor-pointer text-[1rem] text-primary">
              ...
              <div className="mb-8 grid w-full grid-cols-2 gap-4">
                <div className="w-full">
                  <div className="grid w-full items-center gap-1.5">
                    ...
                    <CustomSelect data={game_data} onSelect={(value) => setValue('game', value)} />
                  </div>
                </div>
                <div className="w-full">
                  <div className="grid w-full items-center gap-1.5">
