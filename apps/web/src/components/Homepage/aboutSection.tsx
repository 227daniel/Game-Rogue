...
export default function AboutSection() {
  ...
  return (
    <div
      className="section pt-70 bg-cover bg-center px-5 pt-16 md:px-52"
    ...
    >
      ...
      >
        ...
        />
        <Button
          className="mt-10 rounded-none bg-primary px-16 py-8 font-bold text-white transition duration-200 ease-in-out hover:scale-105 md:mt-10"
