...
export default function SponsoredBySection() {
  return (
    <div className="bg-black py-16">
      ...
      <div className="mt-16">
        <div className="grid grid-cols-1 grid-rows-4 justify-center gap-4 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-4 lg:grid-rows-1 ">
          ...
          <div className="grid grid-cols-3 gap-2 lg:gap-4">
            <div className="mx-auto">
              <Tooltip>
                <Link href="#">
                  <Image
                    src="/static/images/sponsors/OSG Logo.webp"
                    alt=""
                    height={80}
                    width={80}
                  />
