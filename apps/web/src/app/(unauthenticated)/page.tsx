  ...
  return (
    <DefaultLayoutComponent>
      <div className="pt-16">
        ...
        <div
          className="relative flex h-screen max-h-[910px] flex-col items-center justify-center overflow-hidden bg-cover bg-center"
        ...
        <div className="bg-muted pb-12 pt-10 ">
          <CarouselSection />
        </div>
