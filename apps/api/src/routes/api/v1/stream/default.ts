...
export const getStreamsWithCategoriesController = async (req: Request, res: Response) => {
  const streams = await getStreamsWithCategories();
  return res.json({
    data: streams,
    success: true,
    message: 'success',
